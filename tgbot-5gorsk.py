...
cmd_water_meters = '💧 Передать показания счетчиков'
cmd_cancel = 'Отмена'
cmd_yes = 'Да'
cmd_no = 'Нет'
...
🚨 Аварийная служба
🧹 Уборщик
❗️ Работы на территории общедомового имущества проводятся БЕСПЛАТНО.
...
❗️ Заявки по любым вопросам, связанным с обслуживанием дома, если это не в компетенции Доминвест +74993756563❗️
🗑 Забиты мусорки у дома
☃️  Сугробы на стоянке
...
msg_domofon = '📲 Заказ ключей и ремонт домофона +74953957709'

msg_water_zayava = [
    docs(config['zayavas']),
    f'''
❗️Если в квартире никто не проживает, подайте заявление на расчёт исходя из нулевого расхода воды (бланк 1).
...
async def respond(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await send_recursive(context, chat_id, keyboard, reply.strip())
